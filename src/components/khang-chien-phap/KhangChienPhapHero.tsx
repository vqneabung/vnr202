import { Clock, Sword, Trophy, MapPin, Sparkles } from "lucide-react";

const heroStats = [
  { icon: Clock, value: "9", label: "Năm kháng chiến" },
  { icon: Sword, value: "56", label: "Ngày chiến đấu tại ĐBP" },
  { icon: Trophy, value: "1954", label: "Chiến thắng" },
];
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-5 py-2.5 rounded-full mb-8 border border-white/20">
              ...
              <span className="text-[#C9A227] text-sm font-semibold tracking-wider">1945 — 1954</span>
            </div>
            ...
            <div className="flex items-center justify-center gap-2 text-white/60">
              ...
              <span className="text-sm">Điện Biên Phủ - "Lừng lẫy năm châu, chấn động địa cầu"</span>
            </div>
          </div>
